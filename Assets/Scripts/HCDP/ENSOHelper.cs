...
public static class ENSOHelper
{
    ...
    private static readonly HashSet<int> elNinoYears = new() { 1992, 1995, 1998, 2003, 2007, 2010, 2016, 2019 };
    private static readonly HashSet<int> laNinaYears = new() { 1999, 2000, 2008, 2011, 2012, 2020, 2021, 2022 };
